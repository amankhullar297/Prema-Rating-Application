        ...
        <section id="our_features">
            <div class="container">
                <div  class="features_top text-center">
                    <h2 class="title_border">Register Yourself</h2>
                ...
                <div class="features_contant">
                    <div class="row">
                        ...
                        <form method="get"  action="RegisterNowServlet">
                                        <div class="row">
                                            <div class="col-lg-6">
                                               
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input name="name"  class="form-control" type="text"  placeholder="Name" required="true" />
                                                </div>
                                               <div class="form-group">
                                                    <label>Email</label>
                                                ...
                                                <div class="form-group">
                                                    <label>Contact</label>
                                                     <input name="contact"  class="form-control" type="number"  placeholder="Contact" required="true" />
                                                      </div>
                                                                                         <div class="form-group">
                             ...
                             <%GeneralDTO gdt=(GeneralDTO)request.getAttribute("status");
                            		if(gdt!=null && gdt.getStatus()==true){%>
